    ...
    <div className="">
      ...
      <main className="">
        <div className="">
          {/* Header Section */}
          <div className="mb-4">
            <h1 className="h4 fw-bold mb-2">OKR Progress Tracker</h1>
            <p className="text-muted small">Track progress across all objectives and key results</p>
          </div>
              ...
              <div className="card bg-primary text-white">
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span className="h4 font-weight-bold">24</span>
                  </div>
              ...
              <div className="card bg-success text-white">
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span className="h4 font-weight-bold">18</span>
                  </div>
              ...
              <div className="card bg-warning text-white">
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span className="h4 font-weight-bold">4</span>
                  </div>
              ...
              <div className="card bg-danger text-white">
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span className="h4 font-weight-bold">2</span>
                  </div>
              ...
              <div className="card-body">
                <div className="d-flex flex-column flex-md-row justify-content-between align-items-start mb-4">
                  <div className="d-flex align-items-center gap-3 mb-3 mb-md-0">
                    ...
                    <div>
                      <h3 className="h6 font-weight-semibold text-dark">Increase Revenue Growth</h3>
                  ...
                  <div className="text-md-right">
                    <div className="h4 font-weight-bold text-primary mb-2">82%</div>
                ...
                <div className="row bg-light rounded p-3">
                  <div className="col-md-4 text-center mb-3 mb-md-0">
                    <div className="h5 font-weight-semibold">85%</div>
                    <div className="small text-muted">New Customer Acquisition</div>
                  </div>
                  <div className="col-md-4 text-center mb-3 mb-md-0">
                    <div className="h5 font-weight-semibold">75%</div>
                    <div className="small text-muted">Upsell Existing Accounts</div>
                  </div>
                  <div className="col-md-4 text-center">
                    <div className="h5 font-weight-semibold">90%</div>
              ...
              <div className="card-body">
                <div className="d-flex flex-column flex-md-row justify-content-between align-items-start mb-4">
                  <div className="d-flex align-items-center gap-3 mb-3 mb-md-0">
                    ...
                    <div>
                      <h3 className="h6 font-weight-semibold text-dark">Improve Product Quality</h3>
                      <div className="d-flex flex-wrap gap-3 text-muted small">
                        <span className="d-flex align-items-center gap-1">
                          <i className="fas fa-user"></i>
                          Engineering Team
                  ...
                  <div className="text-md-right">
                    <div className="h4 font-weight-bold text-purple mb-2">58%</div>
                    <div className="progress" style={{ width: '130px', height: '6px' }}>
                      <div 
                ...
                <div className="row bg-light rounded p-3">
                  <div className="col-md-4 text-center mb-3 mb-md-0">
                    <div className="h5 font-weight-semibold">45%</div>
                    <div className="small text-muted">Bug Resolution Rate</div>
                  </div>
                  <div className="col-md-4 text-center mb-3 mb-md-0">
                    <div className="h5 font-weight-semibold">65%</div>
              ...
              <div className="card-body">
                <div className="d-flex flex-column flex-md-row justify-content-between align-items-start mb-4">
                  <div className="d-flex align-items-center gap-3 mb-3 mb-md-0">
                    ...
                    <div>
                      <h3 className="h6 font-weight-semibold text-dark">Enhance Brand Awareness</h3>
                      <div className="d-flex flex-wrap gap-3 text-muted small">
                        <span className="d-flex align-items-center gap-1">
                          <i className="fas fa-user"></i>
                          Marketing Team
                  ...
                  <div className="text-md-right">
                    <div className="h4 font-weight-bold text-success mb-2">73%</div>
                    <div className="progress" style={{ width: '130px', height: '6px' }}>
                      <div 
                ...
                <div className="row bg-light rounded p-3">
                  <div className="col-md-4 text-center mb-3 mb-md-0">
                    <div className="h5 font-weight-semibold">80%</div>
                    <div className="small text-muted">Social Media Reach</div>
                  </div>
                  <div className="col-md-4 text-center mb-3 mb-md-0">
                    <div className="h5 font-weight-semibold">70%</div>
              ...
              <div className="card-body">
                <div className="d-flex flex-column flex-md-row justify-content-between align-items-start mb-4">
                  <div className="d-flex align-items-center gap-3 mb-3 mb-md-0">
                    ...
                    <div>
                      <h3 className="h6 font-weight-semibold text-dark">Improve Customer Satisfaction</h3>
                      <div className="d-flex flex-wrap gap-3 text-muted small">
                        <span className="d-flex align-items-center gap-1">
                          <i className="fas fa-user"></i>
                          Customer Success
                  ...
                  <div className="text-md-right">
                    <div className="h4 font-weight-bold text-warning mb-2">35%</div>
                    <div className="progress" style={{ width: '130px', height: '6px' }}>
                      <div 
                ...
                <div className="row bg-light rounded p-3">
                  <div className="col-md-4 text-center mb-3 mb-md-0">
                    <div className="h5 font-weight-semibold">40%</div>
                    <div className="small text-muted">NPS Score Improvement</div>
                  </div>
                  <div className="col-md-4 text-center mb-3 mb-md-0">
                    <div className="h5 font-weight-semibold">30%</div>
                    <div className="small text-muted">Support Response Time</div>
                  </div>
                  <div className="col-md-4 text-center">
                    <div className="h5 font-weight-semibold">35%</div>
